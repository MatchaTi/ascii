...
3. Tidak boleh menggunakan hoodie saat kegiatan praktikum di laboratorium.
...
2. **Pelanggaran Ringan**
    *Pelanggaran yang tidak secara langsung mengganggu jalannya praktikum secara signifikan, namun menunjukkan ketidakdisiplinan.*
    - **Sanksi Teguran Lisan** (diberikan untuk pelanggaran pertama kali):
        ...
        - Keterlambatan masuk kelas/sesi daring (kurang dari 30 menit) lebih dari itu akan tidak akan ada nilai dan tidak ada presensi absent.
